            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title"><b>Absensi Anggota Hari Ini</b></h4>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-chart">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Tingkat kehadiran Anggota</h4>
                        <p class="card-category">Jumlah kehadiran Anggota dalam 7 hari terakhir</p>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
