      ...
      <div class="col-lg-12 col-md-12">
        ...
        <div class="card">
          <div class="card-header card-header-danger">
            ...
            <p class="card-category">Generate QR berdasarkan kode unik data Anggota/Dosen</p>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="card">
                  <div class="card-body">
                    <h4 class="text-primary"><b>Data Anggota</b></h4>
                    <p>Total jumlah Anggota : <b><?= count($siswa); ?></b>
                      <br>
                    ...
                    <br>
                    <p>
                      Untuk generate/download QR Code per masing-masing Anggota kunjungi
                      <a href="<?= base_url('admin/siswa'); ?>"><b>data Anggota</b></a>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <p>
                      ...
                      <a href="<?= base_url('admin/guru'); ?>" class="text-success"><b>data Dosen</b></a>
                    </p>
                  </div>
                </div>
                <p class="text-danger">
